    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="space-y-10 text-slate-700 leading-relaxed text-sm sm:text-base">
        ...
        <section className="space-y-3">
          ...
          <p>
            Like most technical websites, TechOps Wire follows standard procedures for utilizing log files. When visitors access our tutorials, our web servers automatically log certain non-personally identifiable information.
          </p>
          <p>
            This information includes Internet Protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and the number of clicks. These logs are used solely to analyze technical trends, administer the site, prevent denial-of-service attacks, and ensure reliable server uptime. This data is not linked to any personally identifiable information.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            TechOps Wire uses cookies to store information about visitors&apos; preferences and to record user-specific information on which pages the visitor accesses. This helps us optimize our technical content and improve site performance.
          </p>
          <p>
        ...
        <section className="space-y-3">
          ...
          <p>
            TechOps Wire does not require user registration, passwords, or personal profile creation to read our guides.
          </p>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-slate-900 tracking-tight">
            4. External Technical Documentation Links
          </h2>
          <p>
            Our tutorials regularly cite and link to primary source documentation, such as Microsoft Learn, Amazon Web Services Documentation, Linux man pages, and GitHub source code repositories.
          </p>
          <p>
