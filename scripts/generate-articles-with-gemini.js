...
const BANNED_WORDS = [
  { pattern: /\bA deep dive into\b/gi, replacement: "An analysis of" },
  { pattern: /\bA Guide to\b/gi, replacement: "A Tutorial on" },
  { pattern: /\bAdopting\b/gi, replacement: "Using" },
  { pattern: /\bAdopt\b/gi, replacement: "Use" },
  { pattern: /\bAn in-depth look (at|into)\b/gi, replacement: "An examination of" },
  { pattern: /\bAs we look ahead\b/gi, replacement: "Going forward" },
  ...
  { pattern: /\bComprehensive Guide( to)?\b/gi, replacement: "Reference" },
  { pattern: /\bComprehensive\b/gi, replacement: "Complete" },
  { pattern: /\bCornerstone\b/gi, replacement: "Foundation" },
  { pattern: /\bCrucial component\b/gi, replacement: "Key component" },
  { pattern: /\bCrucial\b/gi, replacement: "Essential" },
  { pattern: /\bDeep dive\b/gi, replacement: "Detailed walkthrough" },
  { pattern: /\bDelve into\b/gi, replacement: "Examine" },
  { pattern: /\bDelve\b/gi, replacement: "Investigate" },
  { pattern: /\bDelving\b/gi, replacement: "Investigating" },
  { pattern: /\bDemystifying\b/gi, replacement: "Explaining" },
  { pattern: /\bDiscover verified facts\b/gi, replacement: "Check details" },
  { pattern: /\bDiscover\b/gi, replacement: "Inspect" },
  { pattern: /\bDive into\b/gi, replacement: "Review" },
  { pattern: /\bElevate\b/gi, replacement: "Improve" },
  { pattern: /\bEmbark\b/gi, replacement: "Begin" },
  { pattern: /\bEnterprise-grade\b/gi, replacement: "Production" },
  { pattern: /\bEvolution\b/gi, replacement: "Growth" },
  { pattern: /\bExplore\b/gi, replacement: "Review" },
  { pattern: /\bExtracting\b/gi, replacement: "Filtering" },
  { pattern: /\bFind verified facts\b/gi, replacement: "Check facts" },
  { pattern: /\bFoster\b/gi, replacement: "Support" },
  { pattern: /\bFurthermore\b/gi, replacement: "Also" },
  { pattern: /\bGame-changer\b/gi, replacement: "Breakthrough" },
  { pattern: /\bGuide\b/gi, replacement: "Tutorial" },
  { pattern: /\bHarness\b/gi, replacement: "Apply" },
  { pattern: /\bHelpful background( details and common queries)?\b/gi, replacement: "Context" },
  { pattern: /\bHigh-Fidelity\b/gi, replacement: "Accurate" },
  { pattern: /\bIn conclusion\b/gi, replacement: "Summary" },
  { pattern: /\bIn this article(, we explore)?\b/gi, replacement: "Here" },
  { pattern: /\bIn today's digital era\b/gi, replacement: "Today" },
  { pattern: /\bIn today's fast-paced( digital world)?\b/gi, replacement: "Today" },
  { pattern: /\bIn-depth\b/gi, replacement: "Detailed" },
  { pattern: /\bIt is crucial to\b/gi, replacement: "You must" },
  { pattern: /\bIt is important to (note|remember)\b/gi, replacement: "Note that" },
  { pattern: /\bKey Insights\b/gi, replacement: "Takeaways" },
  { pattern: /\bLandscape\b/gi, replacement: "Field" },
  { pattern: /\bLearn how\b/gi, replacement: "See how" },
  { pattern: /\bLearn more( details| now| today)?\b/gi, replacement: "Read more" },
  { pattern: /\bLearn\b/gi, replacement: "Understand" },
  { pattern: /\bLeverage\b/gi, replacement: "Use" },
  { pattern: /\bLook no further\b/gi, replacement: "Here is what to use" },
  { pattern: /\bModern teams adopting\b/gi, replacement: "Teams running" },
  { pattern: /\bModern\b/gi, replacement: "Current" },
  { pattern: /\bMoreover\b/gi, replacement: "In addition" },
  { pattern: /\bNavigating( the)?\b/gi, replacement: "Managing" },
  { pattern: /\bOrchestrate\b/gi, replacement: "Manage" },
  { pattern: /\bParadigm shift\b/gi, replacement: "Major shift" },
  { pattern: /\bPipelines\b/gi, replacement: "Workflows" },
  { pattern: /\bPivotal\b/gi, replacement: "Critical" },
  { pattern: /\bPlethora\b/gi, replacement: "Large amount" },
  { pattern: /\bPowerhouse\b/gi, replacement: "Engine" },
  { pattern: /\bRealm\b/gi, replacement: "Area" },
  { pattern: /\bRobust\b/gi, replacement: "Resilient" },
  { pattern: /\bSeamlessly\b/gi, replacement: "Smoothly" },
  { pattern: /\bSeamless\b/gi, replacement: "Smooth" },
  { pattern: /\bTapestry\b/gi, replacement: "Architecture" },
  { pattern: /\bTechnical\b/gi, replacement: "System" },
  { pattern: /\bTestament\b/gi, replacement: "Evidence" },
  { pattern: /\bThe Ultimate\b/gi, replacement: "The Primary" },
  { pattern: /\bUltimate Guide\b/gi, replacement: "Complete Reference" },
  { pattern: /\bUltimate\b/gi, replacement: "Principal" },
  { pattern: /\bUltra-High\b/gi, replacement: "Very high" },
  { pattern: /\bUncover\b/gi, replacement: "Reveal" },
  { pattern: /\bUnleash\b/gi, replacement: "Release" },
  { pattern: /\bUnlock\b/gi, replacement: "Enable" },
  { pattern: /\bUnpacking\b/gi, replacement: "Examining" },
  { pattern: /\bVerified\b/gi, replacement: "Confirmed" },
  { pattern: /\bVital role\b/gi, replacement: "Major role" },
